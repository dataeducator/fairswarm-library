...
def record(
    name: str, category: str, component: str, outcome: str, detail: str, severity: int
) -> None:
...
class TestDemographicDistributionEdgeCases:
    ...
    def test_all_nan_values(self):
        ...
        try:
            DemographicDistribution(values=np.array([float("nan")] * 4))
            record(
                "all_nan_values",
                "NaN",
                "DemographicDistribution",
    ...
    def test_inf_in_values(self):
        ...
        try:
            DemographicDistribution(values=np.array([0.5, float("inf"), 0.5]))
            record(
                "inf_in_values",
                "Inf",
                "DemographicDistribution",
    ...
    def test_negative_values_summing_to_one(self):
        ...
        try:
            DemographicDistribution(values=np.array([-0.5, 1.0, 0.5]))
            record(
                "neg_sum_one",
                "Outlier",
                "DemographicDistribution",
    ...
    def test_empty_values(self):
        ...
        try:
            DemographicDistribution(values=np.array([]))
            record(
                "empty_values",
                "Empty",
                "DemographicDistribution",
    ...
    def test_single_element(self):
        ...
        try:
            ...
            record(
                ...
                "DemographicDistribution",
                "HANDLED",
                "Single-group distribution works",
                1,
            )
    ...
    def test_very_large_k(self):
        ...
        try:
            ...
            record(
                ...
                "DemographicDistribution",
                "HANDLED",
                "10000-group distribution works",
                1,
            )
        except Exception as e:
            record(
    ...
    def test_all_zeros(self):
        ...
        try:
            DemographicDistribution(values=np.array([0.0, 0.0, 0.0, 0.0]))
            record(
                "all_zeros",
                "Empty",
                "DemographicDistribution",
...
class TestKLDivergenceEdgeCases:
    ...
    def test_nan_in_p(self):
        ...
        try:
            ...
            record(
                "nan_in_p", "NaN", "kl_divergence", "HANDLED", "Rejected NaN input", 1
            )
    ...
    def test_empty_arrays(self):
        ...
        try:
            ...
            record("empty_arrays", "Empty", "kl_divergence", "HANDLED", "Rejected", 1)
    ...
    def test_length_mismatch(self):
        ...
        try:
            ...
            record(
                "length_mismatch", "TypeSwap", "kl_divergence", "HANDLED", "Rejected", 1
            )
...
class TestClientEdgeCases:
    ...
    def test_nan_demographics(self):
        ...
        try:
            ...
            record("nan_client_demo", "NaN", "Client", "HANDLED", "Rejected", 1)
    ...
    def test_zero_dataset_size(self):
        ...
        try:
            ...
            record("zero_dataset", "Boundary", "Client", "HANDLED", "Rejected", 1)
    ...
    def test_negative_dataset_size(self):
        ...
        try:
            ...
            record("neg_dataset", "Outlier", "Client", "HANDLED", "Rejected", 1)
    ...
    def test_negative_communication_cost(self):
        ...
        try:
            ...
            record("neg_comm_cost", "Outlier", "Client", "HANDLED", "Rejected", 1)
    ...
    def test_communication_cost_above_one(self):
        ...
        try:
            ...
            record("high_comm_cost", "Outlier", "Client", "HANDLED", "Rejected", 1)

    def test_duplicate_client_ids(self):
        """Multiple clients with same ID (no dedup)."""
        Client(id="dup", demographics=np.array([0.5, 0.5]), dataset_size=100)
        Client(id="dup", demographics=np.array([0.3, 0.7]), dataset_size=200)
        ...
        record(
            ...
            "Client",
            "HANDLED",
            "Duplicate IDs allowed (no id uniqueness constraint)",
            1,
        )
    ...
    def test_duplicate_indices(self):
        ...
        if abs(result_dup - result_single) < 1e-10:
            record(
                ...
                "coalition_divergence",
                "HANDLED",
                "Duplicates produce same result as single (correct for mean)",
                1,
            )
        else:
            record(
...
class TestFairSwarmEdgeCases:
    ...
    def test_coalition_larger_than_n(self):
        ...
        try:
            ...
            record("coalition_gt_n", "Boundary", "FairSwarm", "HANDLED", "Rejected", 1)
    ...
    def test_mismatched_k(self):
        ...
        c2 = Client(
            id="c2", demographics=np.array([0.33, 0.34, 0.33]), dataset_size=100
        )
        try:
            fs = FairSwarm(
                clients=[c1, c2],
            ...
            fs.optimize(
                fitness_fn=DemographicFitness(target_distribution=self._make_target(2)),
                n_iterations=5,
                verbose=False,
            )
            record(
            ...
            record(
                "mismatched_k", "TypeSwap", "FairSwarm", "HANDLED", f"Rejected: {e}", 1
            )
        ...
        try:
            ...
            if result.coalition is not None and len(result.coalition) == 3:
                record(
                    ...
                    "FairSwarm",
                    "HANDLED",
                    "Zero iters returns initial best",
                    1,
                )
            else:
                record(
            ...
            record(
                ...
                "FairSwarm",
                "HANDLED",
                "Config rejects max_iterations=0 (correct validation)",
                1,
            )
        except Exception as e:
...
class TestCombineDistributionsEdgeCases:
    ...
    def test_single_distribution(self):
        ...
        record(
            ...
            "combine_distributions",
            "HANDLED",
            "Single distribution returned unchanged",
            1,
        )
...
class TestConfigEdgeCases:
    ...
    def test_negative_inertia(self):
        ...
        try:
            ...
            record(
                "neg_inertia", "Outlier", "FairSwarmConfig", "HANDLED", "Rejected", 1
            )
    ...
    def test_inertia_above_one(self):
        ...
        try:
            ...
            record(
                "high_inertia", "Outlier", "FairSwarmConfig", "HANDLED", "Rejected", 1
            )

    def test_zero_swarm_size(self):
        """Swarm with 0 particles."""
        try:
            FairSwarmConfig(swarm_size=0)
            record(
                "zero_swarm",
                "Boundary",
                "FairSwarmConfig",
            ...
            record(
                "zero_swarm", "Boundary", "FairSwarmConfig", "HANDLED", "Rejected", 1
            )
    ...
    def test_negative_epsilon_fair(self):
        ...
        try:
            ...
            record(
                "neg_eps_fair", "Outlier", "FairSwarmConfig", "HANDLED", "Rejected", 1
            )
        ...
        try:
            ...
            if result.value == float("-inf") or result.value < -1e10:
                record(
                    ...
                    "DemographicFitness",
                    "HANDLED",
                    "Empty coalition returns -inf fitness",
                    1,
                )
            else:
                record(
    ...
    def test_single_client_fitness(self):
        ...
        try:
            ...
            record(
                ...
                "DemographicFitness",
                "HANDLED",
                f"Single client fitness = {result.value:.4f}",
                1,
            )
        except Exception as e:
            record(
